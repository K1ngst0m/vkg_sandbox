...
namespace vkutil {
    bool load_image_from_file(VulkanEngine& engine, const char* file, AllocatedImage& outImage) {
        ...
        // map to staging buffer
        void* pixel_ptr = pixels;
        VkDeviceSize imageSize = texWidth * texHeight * 4;
        VkFormat image_format = VK_FORMAT_R8G8B8A8_SRGB;
        AllocatedBuffer stagingBuffer = engine.create_buffer(imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VMA_MEMORY_USAGE_CPU_ONLY, false);
        void* data;
        ...
        engine.immediate_submit([&](VkCommandBuffer cmd) {
            // turn new image to transfer dst optimal layout
            ...
            imageBarrier_toTransfer.subresourceRange = barrierRange;
            imageBarrier_toTransfer.srcAccessMask = 0;
            imageBarrier_toTransfer.dstAccessMask = VK_ACCESS_TRANSFER_WRITE_BIT;
            vkCmdPipelineBarrier(cmd, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, VK_PIPELINE_STAGE_TRANSFER_BIT, 0, 0, nullptr, 0, nullptr, 1, &imageBarrier_toTransfer);

            // copy staging buffer to new image
            ...
            // turn new image(copyed) to shader optimal layout
